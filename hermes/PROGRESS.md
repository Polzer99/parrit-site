...
- [item 10 — DÉCISION PAUL] Palette : app TRUTH §6.3 (`#F5F8FF`/`#161616`/`#AA0003`) vs **canon design-system** + ressources statiques + nouvelles pages légales (`#FFFDFA`/`#0C0C0D`/`#D1132F`). Le skill design-system marque `#F5F8FF`/`#AA0003` comme **PÉRIMÉS** → reco = migrer l'app vers le canon, mais c'est un re-skin complet du site : **Paul confirme le canon avant migration** (ne PAS re-skinner seul).
