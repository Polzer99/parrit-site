...
|---|---|---|---|---|
| Fiche 7 niveaux "IA generative -> IA agentique" | DG, DRH, prospects N1/N2 | A produire | Montagne maturite, 7 niveaux, 1 exemple par niveau, CTA diagnostic. | PDF 1 page + image LinkedIn. |
| Fiche avant / apres par persona | DG, CCO, owner e-commerce, transfo, e-commerce retail | A produire | Avant, apres, 3 use cases, ressource suivante. | PDF court par persona. |
