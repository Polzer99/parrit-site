...
> Source canonique pour les one-pagers, la section home, Hermès, séquences outbound.
...
- (Note interne : "prompts" → écrire "instructions personnalisées" ou "configurations" dans le copy site)
- Pas de tiret cadratin (—)
- CTA : "Réserver" (N1–N3) · "Demander l'audit" (N4) · "En parler 15 min" (N5–N7)

---

## Tableau des 7 niveaux

| Niveau | Nom | Focus | Livrable clé | Route |
|--------|-----|-------|-------------|-------|
| N1 | Masterclass Généraliste | Acculturation & initiation | Deck de présentation complet | `/masterclass-ia` |
| N2 | Masterclass Métier | Application concrète au secteur | Instructions personnalisées métier | `/masterclass-metier` |
...
## Notes de déploiement Codex

- Composant partagé `OnePager.tsx` utilisé par les 7 pages
- `/[lang]/audit-claude-code` → redirect 301 vers `/[lang]/audit`
- `/[lang]/sprint` → redirect 301 vers `/[lang]/deploiement-agents` (contenu N5)
- SSG : `generateStaticParams` pour fr / en / pt-BR / zh-CN
- Prix : toujours "à partir de X €" dans le HTML — jamais de prix exact
- CTA bas de page : `mailto:paul.larmaraud@parrit.ai` + WhatsApp
