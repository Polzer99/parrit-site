...
- **Arpona**, poids 500 à 600. *(Corrigé le 31/07/2026, ADR-007 : ce contrat disait « display condensed font », ce qui a servi à justifier Barlow Condensed. La police display est Arpona.)*
- Uppercase for manifesto/editorial pages; sentence case for product usability.
- **Line height: `1.08`, never below `1.04`.** *(Corrigé le 31/07/2026, ADR-013 : ce contrat disait « tight line height: 0.88–1.02 ». Mesuré, cette fourchette fait collider les capitales accentuées françaises, dont l'encre occupe 1.038 em en Arpona SemiBold. Voir `01_DESIGN_TOKENS.md`.)*
- Maximum 10–12 words in a hero.
- Prefer a strong line break over shrinking text.
- **Red on one segment maximum**, and only if that segment carries a cause, a problem, a transformation, a result or the subject. The headline must keep its full meaning read entirely in black. *(ADR-012.)*
