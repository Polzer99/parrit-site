...
| ADR-018 | `docs/design-system/DECISIONS.md` | Concept D source visuelle de vérité, 01/08 · **supersédée par ADR-019** |
| ADR-019 | `docs/design-system/DECISIONS.md` | Concept D conservé comme prototype, pas comme canon final, 01/08 |
| ADR-020 et suivants | **ici** ou `docs/design-system/DECISIONS.md` | selon le document propriétaire de la règle |
