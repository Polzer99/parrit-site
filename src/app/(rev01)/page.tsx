...
const DICT = {
  en: {
    metaTitle: "Parrit.ai · Company Operating Systems",
    metaDescription: "Parrit.ai examines how a company operates, builds its first production system and compounds it as owned infrastructure.",
    hero: { kicker: "Parrit / Company operating systems", before: "The AI system your company", frame: "operates", after: "on.", sub: "Built by Parrit.ai, a French maison founded by Paul Larmaraud: three years of AI systems deployed across large accounts, SMEs and mid-sized companies.", primary: "Let’s talk", secondary: "Examine the Standard" },
    instrument: {
    ...
    dossiers: [
      { ref: "DOSSIER 26-001", sector: "PARRIT ITSELF", title: "The system we sell is the system we run.", body: "Parrit.ai operates on its own operating system: one place where signals, clients and campaigns become decisions, delivered to the founder’s phone as cards. Built for ourselves first, compounding since.", value: "200+", result: "signals become decisions, every week", seal: "In production · Compounding" },
    ...
    faq: [
      ["Who is Parrit.ai?", "An independent French maison, founded by Paul Larmaraud and steered by its partners, with twenty engineers and operators around the project. A registered company whose full legal identity is one click away, under /Legal. Deliberately small at the core: we take few commissions, and a partner personally builds each one. The Journal is where our thinking is public."],
      ["What do we own at the end?", "Everything, from the start. The repository is yours from the first commit; the system runs in your accounts, on your infrastructure, under your keys. It is built on ordinary, widely-adopted technology (TypeScript, Python, PostgreSQL), so any competent engineer can maintain it without us. That is the mechanism behind PS-05, not a promise: if Parrit.ai disappears tomorrow, your system does not notice."],
      ["Where does our data live?", "In your perimeter. Parrit.ai builds inside your own accounts and infrastructure from day one. Your data never lives on Parrit.ai’s servers, and our access ends the day you revoke it. GDPR posture follows from that: nothing changes hands to lose."],
  ...
  fr: {
    metaTitle: "Parrit.ai · Le système IA qui fait tourner votre entreprise",
    metaDescription: "Parrit.ai conçoit et construit des systèmes d'exploitation d'entreprise : un seul système pour comprendre, décider et agir. Une entreprise à la fois. Une commande, pas un abonnement.",
    hero: { kicker: "Parrit / Systèmes d'exploitation d'entreprise", before: "Le système IA qui fait tourner votre", frame: "entreprise.", after: "", sub: "Construit par Parrit.ai, maison française fondée par Paul Larmaraud, après trois ans de projets déployés chez des grands comptes, des PME et des ETI.", primary: "Parlons-en", secondary: "Examiner le Standard" },
    instrument: {
    ...
    faq: [
      ["Qui est Parrit.ai ?", "Une maison française indépendante, fondée par Paul Larmaraud et menée par ses associés, avec vingt ingénieurs et opérateurs autour du projet. Une société immatriculée, dont l'identité légale complète est à un clic, sous Mentions légales. Volontairement resserrée : nous acceptons peu de commandes, et un associé construit chacune en personne. Notre réflexion est publique : elle se lit dans le Journal."],
      ["Qu'est-ce qui nous appartient à la fin ?", "Tout, dès le départ. Le dépôt de code est à vous dès la première ligne ; le système tourne dans vos comptes, sur votre infrastructure, avec vos clés. Il repose sur des technologies ordinaires et largement répandues (TypeScript, Python, PostgreSQL) : n'importe quel ingénieur compétent peut le maintenir sans nous. C'est ce qui garantit PS-05. Un mécanisme, pas une promesse. Si Parrit.ai disparaît demain, votre système ne s'en aperçoit pas."],
      ["Où vivent nos données ?", "Chez vous. Parrit.ai construit dans vos comptes et sur votre infrastructure dès le premier jour. Vos données ne passent jamais par les serveurs de Parrit.ai, et notre accès s'arrête le jour où vous le coupez. La conformité RGPD en découle : rien ne change de mains, rien ne peut se perdre."],
