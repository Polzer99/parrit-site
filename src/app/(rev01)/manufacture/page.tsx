...
const DICT = {
  en: {
    metaTitle: "The Manufacture", metaDescription: "How Parrit designs and builds a company operating system: examination, construction, compounding. One company at a time, certified to the Parrit Standard.",
    ...
    principles: [
      ...
      ["Built in your perimeter", "The system is built in your accounts, on your infrastructure, under your keys from the first day, not at handover. Your data never lives on Parrit’s servers, and our access ends the day you revoke it. Security is not a clause in a contract; it is where the system physically lives."],
      ["Owned, not rented", "Everything you receive is yours: code, data, documentation, handed over as company assets. The repository is yours from the first commit, and the system is built on ordinary, widely-adopted technology (TypeScript, Python, PostgreSQL), so any competent engineer can maintain it without us. Commissioned, not subscribed: if Parrit disappears tomorrow, your system does not."],
    ],
  ...
  fr: {
    metaTitle: "La Manufacture", metaDescription: "Comment Parrit conçoit et construit un système d'exploitation d'entreprise : examen, construction, capitalisation. Une entreprise à la fois, chaque système certifié selon le Standard Parrit.",
