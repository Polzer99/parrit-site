...
export async function GET(): Promise<Response> {
  ...
  const lines: string[] = [
    ...
    "- Transformation IA (/croissance) : advisory COMEX/DSI, transformation de bout en bout. Sur devis.",
    "- Agent IA / Sprint agentique (/deployer) : un agent en production contrôlée sur un workflow prioritaire. Sur devis.",
    "- Formation agentique (/transmettre) : rendre les équipes autonomes sur les agents, ateliers hands-on, finançable OPCO. Sur devis.",
