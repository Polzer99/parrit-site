...
export const config = {
  matcher: [
    ...
    "/((?!_next|api|os|fondateurs|academy|chemin|metiers|harnais-ia|outils|diagnostic|demarrer-claude-code|architecture-claude-md|efi-audit-hotels|favicon.ico|robots.txt|sitemap.xml|og-image.png|.*\\..*).*)",
  ],
};
