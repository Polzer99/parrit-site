...
export const OFFER_COPY: Record<Locale, Record<OfferKind, OfferCopy>> = {
  ...
  en: {
    ...
    transmettre: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "A ", accent: "simple, legible", after: " frame.", rows: [{ label: "Rate", value: "€250/h", note: "individual or team sessions" }, { label: "Certification", value: "Qualiopi", note: "certified training provider" }, { label: "For", value: "Leadership, business units" }, { label: "Format", value: "Hands-on workshops", note: "on your real cases" }, { label: "Stack", value: "Claude Code, Codex, MCP, security" }] },
  ...
  "pt-BR": {
    ...
    transmettre: withCommon("pt-BR", {
      ...
      spec: { kicker: "Quadro", title: "Um quadro ", accent: "simples e legível", after: ".", rows: [{ label: "Valor", value: "€ 250/h", note: "sessões individuais ou em equipe" }, { label: "Certificação", value: "Qualiopi", note: "organismo certificado" }, { label: "Para", value: "Direção geral, áreas de negócio" }, { label: "Formato", value: "Workshops hands-on", note: "nos seus casos reais" }, { label: "Stack", value: "Claude Code, Codex, MCP, segurança" }] },
  ...
  "zh-CN": {
    ...
    transmettre: withCommon("zh-CN", {
      ...
      spec: { kicker: "框架", title: "一个", accent: "简单清晰", after: "的框架。", rows: [{ label: "费用", value: "€250/小时", note: "个人或团队课程" }, { label: "认证", value: "Qualiopi", note: "已认证培训机构" }, { label: "适合", value: "管理层、业务部门" }, { label: "形式", value: "Hands-on 工作坊", note: "基于你的真实案例" }, { label: "Stack", value: "Claude Code、Codex、MCP、安全" }] },
