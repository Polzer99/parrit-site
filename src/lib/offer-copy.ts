...
export const OFFER_COPY: Record<Locale, Record<OfferKind, OfferCopy>> = {
  ...
  en: {
    deployer: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "Scope, timing, quote: ", accent: "defined before build", after: ".", rows: [{ label: "Duration", value: "based on scope", note: "validated after diagnosis" }, { label: "Front", value: "Operations OS or Growth OS" }, { label: "Impact sprint", value: "Custom quote", note: "flagship format" }, { label: "AI agent deployment", value: "Custom quote" }, { label: "Compliance", value: "GDPR, EU AI Act, your data stays with you" }] },
    ...
    croissance: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "A ", accent: "clear model", after: ", no surprises.", rows: [{ label: "Model", value: "Deployment then fixed run", note: "no commission" }, { label: "Deployment", value: "Custom quote", note: "ICP, signals, sequences" }, { label: "Run", value: "Support · Operating Partner", note: "Custom quote" }, { label: "Signals", value: "podcasts, events, LinkedIn" }, { label: "Bonus", value: "Generative visibility (GEO)", note: "being cited by answer engines" }] },
    ...
    transmettre: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "A ", accent: "simple, legible", after: " frame.", rows: [{ label: "Agentic training", value: "Custom quote", note: "non-tech, OPCO-financeable" }, { label: "Format", value: "Hands-on workshops", note: "on your real cases" }, { label: "Stack", value: "Claude Code, Codex, MCP, security" }, { label: "Support", value: "Custom quote", note: "Operating Partner" }] },
  ...
  "pt-BR": {
    deployer: withCommon("pt-BR", {
      ...
      hero: { eyebrow: "Oferta · Implantar", title: "Um agente em ", accent: "produção em 14 dias", after: ", com escopo fechado.", sub: "Você escolhe um workflow crítico. Nós implantamos em um sprint delimitado. Você sai com um sistema rodando, não uma demonstração.", chips: ["14 dias", "Escopo fixo", "Em produção", "Servidores MCP"], primary: "Reservar o sprint", secondary: "Ver o quadro" },
      ...
      spec: { kicker: "Quadro", title: "Escopo, duração, proposta: ", accent: "fechados na assinatura", after: ".", rows: [{ label: "Duração", value: "14 a 21 dias", note: "calendário fixo" }, { label: "Frente", value: "OS Operações ou OS Crescimento" }, { label: "Sprint de impacto", value: "Sob consulta", note: "formato principal" }, { label: "Deploy de agentes IA", value: "Sob consulta" }, { label: "Conformidade", value: "GDPR, EU AI Act, dados com você" }] },
    ...
    croissance: withCommon("pt-BR", {
      ...
      spec: { kicker: "Quadro", title: "Um ", accent: "modelo claro", after: ", sem surpresa.", rows: [{ label: "Modelo", value: "Deploy depois run fixo", note: "sem comissão" }, { label: "Deploy", value: "Sob consulta", note: "ICP, sinais, sequências" }, { label: "Run", value: "Acompanhamento · Operating Partner", note: "Sob consulta" }, { label: "Sinais", value: "podcasts, eventos, LinkedIn" }, { label: "Bônus", value: "Visibilidade generativa (GEO)", note: "ser citado por motores de resposta" }] },
    ...
    transmettre: withCommon("pt-BR", {
      ...
      spec: { kicker: "Quadro", title: "Um quadro ", accent: "simples e legível", after: ".", rows: [{ label: "Formação agentica", value: "Sob consulta", note: "não técnica, financiável OPCO" }, { label: "Formato", value: "Workshops hands-on", note: "nos seus casos reais" }, { label: "Stack", value: "Claude Code, Codex, MCP, segurança" }, { label: "Acompanhamento", value: "Sob consulta", note: "Operating Partner" }] },
  ...
  "zh-CN": {
    deployer: withCommon("zh-CN", {
      ...
      hero: { eyebrow: "服务 · 部署", title: "一个智能体在 ", accent: "14 天内进入生产", after: "，范围固定。", sub: "你选择一个关键工作流。我们用有边界的冲刺部署它。最后你得到的是运行中的系统，不是演示。", chips: ["14 天", "固定范围", "生产中", "MCP 服务器"], primary: "预约冲刺", secondary: "查看框架" },
      ...
      spec: { kicker: "框架", title: "范围、周期、报价：", accent: "签约时确定", after: "。", rows: [{ label: "周期", value: "14 到 21 天", note: "固定日程" }, { label: "战线", value: "运营 OS 或增长 OS" }, { label: "Impact sprint", value: "按需报价", note: "旗舰格式" }, { label: "AI 智能体部署", value: "按需报价" }, { label: "合规", value: "GDPR、EU AI Act，数据留在你方" }] },
    ...
    croissance: withCommon("zh-CN", {
      ...
      spec: { kicker: "框架", title: "一个", accent: "清晰模型", after: "，没有意外。", rows: [{ label: "模式", value: "部署后固定 run", note: "不抽佣" }, { label: "部署", value: "按需报价", note: "ICP、信号、序列" }, { label: "Run", value: "Accompagnement · Operating Partner", note: "按需报价" }, { label: "信号", value: "播客、活动、LinkedIn" }, { label: "加分项", value: "生成式可见性 (GEO)", note: "被答案引擎引用" }] },
    ...
    transmettre: withCommon("zh-CN", {
      ...
      spec: { kicker: "框架", title: "一个", accent: "简单清晰", after: "的框架。", rows: [{ label: "智能体培训", value: "按需报价", note: "非技术，可由 OPCO 资助" }, { label: "形式", value: "Hands-on 工作坊", note: "基于你的真实案例" }, { label: "Stack", value: "Claude Code、Codex、MCP、安全" }, { label: "陪跑", value: "按需报价", note: "Operating Partner" }] },
