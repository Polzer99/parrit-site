...
export const OFFER_COPY: Record<Locale, Record<OfferKind, OfferCopy>> = {
  fr: {
    deployer: withCommon("fr", {
      ...
      spec: {
        kicker: "Le cadre",
        title: "Un agent, un prix : ",
        accent: "clair dès le départ",
        after: ".",
        rows: [
          { label: "Prix", value: "À partir de 2 000 €", note: "par agent, au temps passé" },
          { label: "Modèle", value: "Un agent, un périmètre", note: "vous en ajoutez au besoin" },
          { label: "Cible", value: "Directions métier, direction générale, DSI" },
    ...
    croissance: withCommon("fr", {
      meta: {
        ...
        description: "Un programme de transformation par l'IA : audit, cartographie des cas d'usage prioritaires et déploiement, pour COMEX et DSI.",
      },
      hero: {
        ...
        chips: ["Audit", "Cas d'usage prioritaires", "Déploiement", "COMEX & DSI"],
      ...
      spec: {
        ...
        rows: [
          { label: "Prix", value: "Sur devis", note: "audit + déploiement des cas d'usage" },
          { label: "Point de départ", value: "Audit", note: "cartographie des cas d'usage" },
          { label: "Cible", value: "COMEX, DSI" },
    ...
    transmettre: withCommon("fr", {
      ...
      hero: {
        ...
        chips: ["Claude Code + Codex", "Serveurs MCP", "Certification Calliope", "Human-in-the-loop"],
      ...
      intro: {
        ...
        cardBody: "Le coaching, c'est la dernière étape : après avoir audité et déployé, on donne aux équipes la méthode et la certification pour piloter et faire évoluer leurs agents sans nous.",
      },
      process: {
        kicker: "Formats",
      ...
      spec: {
        ...
        after: ".",
        rows: [
          { label: "Tarif", value: "250 €/h", note: "sessions individuelles ou équipe" },
          { label: "Certification", value: "Calliope", note: "à l'issue du parcours" },
          { label: "Cible", value: "Direction générale, directions métier" },
  ...
  en: {
    deployer: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "One agent, one price: ", accent: "clear upfront", after: ".", rows: [{ label: "Price", value: "From €2,000", note: "per agent, time-based" }, { label: "Model", value: "One agent, one scope", note: "add more as needed" }, { label: "For", value: "Business units, leadership, IT" }, { label: "Duration", value: "based on scope", note: "validated after diagnosis" }, { label: "Compliance", value: "GDPR, EU AI Act, your data stays with you" }] },
    ...
    croissance: withCommon("en", {
      meta: { title: "AI Transformation · Parrit.ai", description: "An AI transformation program: audit, mapping of priority use cases and deployment, for executive committees and IT leadership." },
      ...
      intro: { kicker: "Who it is for", title: "For ", accent: "executive committees and IT leaders", after: " driving AI.", lead: "You need to make AI a real lever, not a pile of POCs. We start from your processes, prioritize high-impact use cases, and deploy the ones that create value, with security and compliance set from day one.", cardTitle: "Why custom quote", cardBody: "A transformation depends on your starting point, your systems and your priorities. We scope it in an audit, then quote a clear deployment plan, with no hollow package." },
      ...
      spec: { kicker: "Frame", title: "A program ", accent: "on custom quote", after: ", scoped by the audit.", rows: [{ label: "Price", value: "Custom quote", note: "audit + use-case deployment" }, { label: "Starting point", value: "Audit", note: "use-case mapping" }, { label: "For", value: "ExCom, IT leadership" }, { label: "Deployment", value: "Priority use cases", note: "in production, in stages" }, { label: "Compliance", value: "GDPR, EU AI Act, your data stays with you" }] },
    ...
    transmettre: withCommon("en", {
      ...
      spec: { kicker: "Frame", title: "A ", accent: "simple, legible", after: " frame.", rows: [{ label: "Rate", value: "€250/h", note: "individual or team sessions" }, { label: "Certification", value: "Calliope", note: "on completion" }, { label: "For", value: "Leadership, business units" }, { label: "Format", value: "Hands-on workshops", note: "on your real cases" }, { label: "Stack", value: "Claude Code, Codex, MCP, security" }] },
  ...
  "pt-BR": {
    deployer: withCommon("pt-BR", {
      ...
      spec: { kicker: "Quadro", title: "Um agente, um preço: ", accent: "claro desde o início", after: ".", rows: [{ label: "Preço", value: "A partir de € 2.000", note: "por agente, por tempo" }, { label: "Modelo", value: "Um agente, um escopo", note: "adicione conforme a necessidade" }, { label: "Para", value: "Áreas de negócio, direção, TI" }, { label: "Duração", value: "conforme escopo", note: "validada após diagnóstico" }, { label: "Conformidade", value: "GDPR, EU AI Act, dados com você" }] },
    ...
    croissance: withCommon("pt-BR", {
      ...
      spec: { kicker: "Quadro", title: "Um programa ", accent: "sob consulta", after: ", enquadrado pela auditoria.", rows: [{ label: "Preço", value: "Sob consulta", note: "auditoria + implantação dos casos de uso" }, { label: "Ponto de partida", value: "Auditoria", note: "mapeamento dos casos de uso" }, { label: "Para", value: "ComEx, TI" }, { label: "Implantação", value: "Casos de uso prioritários", note: "em produção, por etapas" }, { label: "Conformidade", value: "GDPR, EU AI Act, dados com você" }] },
    ...
    transmettre: withCommon("pt-BR", {
      ...
      hero: { eyebrow: "Oferta · Coaching", title: "Coaching. Tornamos você ", accent: "autônomo", after: ".", sub: "Instalamos a stack corretamente (Claude Code, Codex, MCP, segurança), implantamos um primeiro agente com você, e cada pessoa sai com um agente rodando.", chips: ["Claude Code + Codex", "Servidores MCP", "Certificação Calliope", "Human-in-the-loop"], primary: "Falar coaching", secondary: "Ver o quadro" },
      intro: { kicker: "Três formas", title: "Três formas de tornar suas equipes ", accent: "autônomas", after: ".", lead: "Do primeiro agente instalado com você até a governança de longo prazo. Escolhemos conforme seu ponto de partida.", cardTitle: "Por que coaching", cardBody: "O coaching é a última etapa: depois de auditar e implantar, damos às equipes o método e a certificação para operar e evoluir seus agentes sem nós." },
      ...
      spec: { kicker: "Quadro", title: "Um quadro ", accent: "simples e legível", after: ".", rows: [{ label: "Valor", value: "€ 250/h", note: "sessões individuais ou em equipe" }, { label: "Certificação", value: "Calliope", note: "ao concluir" }, { label: "Para", value: "Direção geral, áreas de negócio" }, { label: "Formato", value: "Workshops hands-on", note: "nos seus casos reais" }, { label: "Stack", value: "Claude Code, Codex, MCP, segurança" }] },
  ...
  "zh-CN": {
    deployer: withCommon("zh-CN", {
      ...
      spec: { kicker: "框架", title: "一个智能体，一个价格：", accent: "从一开始就清晰", after: "。", rows: [{ label: "价格", value: "€2,000 起", note: "按智能体、按用时" }, { label: "模式", value: "一个智能体，一个范围", note: "按需增加" }, { label: "适合", value: "业务部门、管理层、IT" }, { label: "周期", value: "按范围", note: "诊断后确认" }, { label: "合规", value: "GDPR、EU AI Act，数据留在你方" }] },
    ...
    croissance: withCommon("zh-CN", {
      ...
      spec: { kicker: "框架", title: "一个", accent: "按需报价", after: "的项目，由审计框定。", rows: [{ label: "价格", value: "按需报价", note: "审计 + 用例部署" }, { label: "起点", value: "审计", note: "用例梳理" }, { label: "适合", value: "管理层、IT" }, { label: "部署", value: "优先用例", note: "分阶段投入生产" }, { label: "合规", value: "GDPR、EU AI Act，数据留在你方" }] },
    ...
    transmettre: withCommon("zh-CN", {
      ...
      hero: { eyebrow: "服务 · 辅导", title: "辅导。我们让你变得", accent: "自主", after: "。", sub: "我们正确安装 stack（Claude Code、Codex、MCP、安全），和你一起部署第一个智能体，每个人离开时都有一个运行中的智能体。", chips: ["Claude Code + Codex", "MCP 服务器", "Calliope 认证", "Human-in-the-loop"], primary: "聊辅导", secondary: "查看框架" },
      intro: { kicker: "三种方式", title: "三种方式让团队", accent: "自主", after: "。", lead: "从与你一起安装第一个智能体，到长期治理。我们根据你的起点选择方式。", cardTitle: "为什么辅导", cardBody: "辅导是最后一步：审计和部署之后，我们把方法和认证交给团队，让他们不依赖我们也能运营和演进智能体。" },
      ...
      spec: { kicker: "框架", title: "一个", accent: "简单清晰", after: "的框架。", rows: [{ label: "费用", value: "€250/小时", note: "个人或团队课程" }, { label: "认证", value: "Calliope", note: "完成后颁发" }, { label: "适合", value: "管理层、业务部门" }, { label: "形式", value: "Hands-on 工作坊", note: "基于你的真实案例" }, { label: "Stack", value: "Claude Code、Codex、MCP、安全" }] },
